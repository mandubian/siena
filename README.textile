...
h3. thin layer on top of low-level DB API
...
Yet, Siena now proposes a new stateful mode to be able to reuse DB resources queries several times, to go through the results keeping last position in memory
