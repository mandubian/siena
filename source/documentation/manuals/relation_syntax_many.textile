...
p(note). **Note** Nevertheless, if you absolutely want to access your own aggregator, it's possible. Go to the "aggregated relation page":./relation_aggregated.textile.
...
h3. <a name="relation-syntax-many-code-fetch">Retrieve the parent & get the children from parent with @asList()@</a>
