h1. <a href="#title">Using __java.math.BigDecimal__ in Siena</a>

h2. <a href="#codesample">Code sample</a>
...
h2. <a href="#annotdesc">@DecimalPrecision Annotation</a>
...
h3. <a href="#sizescale">Size & Scale<a>
...
h3. <a href="#storagetype">Storage Type</a>
