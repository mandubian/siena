...
Be aware, if you don't call commitTransaction, nothing will be committed without your consent. If the connection is closed before commit, in SQL, it will even generate an ILLEGAL_STATE exception.
