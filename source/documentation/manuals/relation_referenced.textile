h1(#title). Reference Relations In Siena

h2(#summary). Summary

A reference relation is:
...
bq. A reference to a model is *physically stored* in the originating model *as a field containing the primary key/id* of the targeted object. In the _YourModel_ table, you should see a column called _ref_ containing the _YourReferencedModel.id_ value of the referenced object.
...
h2(#unowned-one-to-one-1-way). Unowned One-to-One 1-Way
...
h2(#unowned-one-to-one-2-ways). Unowned One-to-One 2-ways
...
h2(#unowned-many-to-one-1-way). Unowned Many-to-One
