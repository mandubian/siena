...
In Siena, we have classified relations between models in 3 categories (at least for the time being):
...
h2(#aggregated). Aggregated relations
...
In this context, we create the _aggregation_ relation when a model aggregates other models. The aggregated model is not 