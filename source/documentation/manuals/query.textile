...
h2. <a name="query-summary">Summary<T>@</a>

p(note). @Query<T>@ is the main entry point for:
* *Ffetching/iterating/paginating/counting* through those multiple entities
* *Uupdating/deleting* multiple entities depending on criteria (filters, orders, aggregators, owners...)
