...
* *DOESN'T manage the updates of data within the related entity*. You must save it yourself.
* *DOESN'T delete the owned entities when you delete the owner* since an owned entity can change owner.
</code></pre>
