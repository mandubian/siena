...
p. This is a new syntax to represent:
...
- _manage relation change_ from one child to another one. 
- _auto-insert the related entity_ at the same time as the parent (or when updating it) if not done yet.
...
* *Siena DOESN'T*
- _manage the updates of data within the related entity_. You must save it yourself.
