...
p(note). *__So Why extending Model?__*

h2. __Model is the class providing the__ "Active Record Pattern":http://en.wikipedia.org/wiki/Active_record_pattern
...
h2. __Model provides access to advanced utilities : Query/Batch/Async__
