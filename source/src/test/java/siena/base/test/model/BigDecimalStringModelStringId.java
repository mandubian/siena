...
public class BigDecimalStringModelStringId {
	...
	public BigDecimalStringModelStringId() {
	}

	public BigDecimalStringModelStringId(String id, BigDecimal big) {
		this.id = id;
		this.big = big;
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		BigDecimalStringModelStringId other = (BigDecimalStringModelStringId) obj;
		if (big == null) {
			if (other.big != null)
				return false;
		} 
