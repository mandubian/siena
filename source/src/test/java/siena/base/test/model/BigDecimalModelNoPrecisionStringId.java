...
public class BigDecimalModelNoPrecisionStringId {
	...
	public BigDecimalModelNoPrecisionStringId() {
	}

	public BigDecimalModelNoPrecisionStringId(String id, BigDecimal big) {
		this.id = id;
		this.big = big;
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		BigDecimalModelNoPrecisionStringId other = (BigDecimalModelNoPrecisionStringId) obj;
		if (big == null) {
			if (other.big != null)
				return false;
		} 
