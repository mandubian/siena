...
@Table("big_decimal_double_stringid")
public class BigDecimalDoubleModelStringId {
	...
	public BigDecimalDoubleModelStringId() {
	}

	public BigDecimalDoubleModelStringId(String id, BigDecimal big) {
		this.id = id;
		this.big = big;
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		BigDecimalDoubleModelStringId other = (BigDecimalDoubleModelStringId) obj;
		if (big == null) {
			if (other.big != null)
				return false;
		} 
