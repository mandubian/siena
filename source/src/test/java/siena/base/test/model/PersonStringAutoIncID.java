...
public class PersonStringAutoIncID {
	...
	public PersonStringAutoIncID() {
	}

	public PersonStringAutoIncID(String id, String firstName, String lastName, String city, int n) {
		this.id = id;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		PersonStringAutoIncID other = (PersonStringAutoIncID) obj;
		if (city == null) {
			if (other.city != null)
				return false;
