...
public class PersonLongAutoID {
	...
	public PersonLongAutoID() {
	}

	public PersonLongAutoID(String firstName, String lastName, String city, int n) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		PersonLongAutoID other = (PersonLongAutoID) obj;
		if (city == null) {
			if (other.city != null)
				return false;
